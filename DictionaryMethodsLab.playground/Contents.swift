...
for charactersMovie in starWarsCharacters.keys {
    print ("These are all the \(charactersMovie)")
...
let keyRemovedfromDict = starWarsCharacters.removeValueForKey("Bounty Hunters")
if keyRemovedfromDict != nil {
